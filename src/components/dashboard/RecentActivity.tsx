      ...
      <div className="p-6">
        <div className="space-y-4">
          {activities.map((activity, index) => (
            <div 
              key={activity.id} 
              className={`relative p-5 rounded-2xl bg-gradient-to-r ${activity.bgGradient} border border-orange-200/30 hover:shadow-xl transition-all duration-300 hover:scale-102 group overflow-hidden`}
            ...
            >
              ...
              <div className="flex items-start space-x-4 relative z-10">
                <div className={`p-4 rounded-2xl bg-gradient-to-br ${activity.gradient} shadow-xl group-hover:scale-110 transition-transform duration-300`}>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-gray-500 font-semibold">{activity.time}</span>
                  </div>
                </div>
                ...
                {activity.amount && (
                  <div className="text-right">
                    ...
                    <div className="w-3 h-3 bg-gradient-to-br from-green-400 to-green-500 rounded-full mt-1 shadow-lg"></div>
                  </div>
                )}
              </div>
            </div>
