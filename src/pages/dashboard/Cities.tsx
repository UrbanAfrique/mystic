          ...
          <div className="p-6">
            {loading ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {cities.map((city) => (
                  <div key={city.id} className="bg-gradient-to-br from-blue-50 to-green-50 rounded-xl border border-blue-200 p-6 hover:shadow-lg transition-all duration-300">
                    {city.image && (
                    ...
                    <h3 className="font-bold text-gray-800 text-lg mb-1">{city.name}</h3>
                    <p className="text-blue-600 text-sm mb-2">{city.region}</p>
                    <p className="text-gray-600 text-sm mb-4 line-clamp-3">{city.description}</p>
